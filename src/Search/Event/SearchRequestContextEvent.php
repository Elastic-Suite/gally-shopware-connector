...
/**
 * Allows a custom project to inject context into a Gally search request before it is sent (e.g. a price group id
 * that can't be deduced from the sales channel context alone).
 */
